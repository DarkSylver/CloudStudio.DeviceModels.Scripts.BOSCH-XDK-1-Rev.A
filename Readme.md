...
# Parsing Script – BOSCH-XDK-1 - Rev. A

This **Parsing** script is designed for the **BOSCH-XDK-1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – BOSCH-XDK-1 Rev. A

Este script de **Parsing** está diseñado para el modelo **BOSCH-XDK-1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
